        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Ajouter un nouveau revenu</h5>
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-item">
                            <label class="my-2">Revenu Titre abrégé</label>
                            <p
                                class="text-danger"
                        ...
                        <div class="form-item">
                            <label class="my-2">Catégorie de revenu</label>
                            <p
                                class="text-danger"
                        ...
                        <div class="form-item">
                            <label class="my-2">Date du revenu</label>
                            <p
                                class="text-danger"
                        ...
                        <div class="form-item">
                            <label class="my-2">Montant du revenu</label>
                            <p
                                class="text-danger"
