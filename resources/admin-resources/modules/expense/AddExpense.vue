        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-item">
                            <label class="my-2">Dépenses Titre abrégé</label>
                            <p
                                class="text-danger"
                        ...
                        <div class="form-item">
                            <label class="my-2">Catégorie de dépenses</label>
                            <p
                                class="text-danger"
                                v-if="
                        ...
                        <div class="form-item">
                            <label class="my-2">Date de la dépense</label>
                            <p
                                class="text-danger"
                        ...
                        <div class="form-item">
                            <label class="my-2">Montant des dépenses</label>
                            <p
                                class="text-danger"
